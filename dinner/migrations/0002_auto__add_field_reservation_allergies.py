...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.allergies'
        db.add_column('dinner_reservation', 'allergies',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.allergies'
        db.delete_column('dinner_reservation', 'allergies')
